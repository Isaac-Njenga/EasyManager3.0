...
exports.deleteWarehouse = exports.distributeWarehouseInventory = exports.updateWarehouse = exports.fetchWarehouseById = exports.fetchWarehouses = exports.createWarehouse = void 0;
...
exports.distributeWarehouseInventory = (0, catchAsync_1.catchAsync)(async (req, res) => {
    const id = getWarehouseIdParam(req.params.id);
    const warehouse = await warehouse_service_1.WarehouseService.distributeInventory(id, req.body);
    res.status(200).json({
        success: true,
        data: warehouse,
