...
export const shopsData: Shop[] = [
		...
		inventoryItems: [
			{
				...
				status: 'Active',
				totalQuantity: 18,
				inventory: [{ locationId: 'shop_westlands_003', locationType: 'Shop', quantity: 3 }],
			...
			},
			{
				...
				status: 'Active',
				totalQuantity: 8,
				inventory: [{ locationId: 'shop_westlands_003', locationType: 'Shop', quantity: 2 }],
			...
			},
			{
				...
				description:
					'Intricately patterned headboard inspired by traditional Lamu wooden door motifs.',
				category: 'Bedroom',
				costPrice: 55000,
				sellingPrice: 135000,
				status: 'Active',
		...
		inventoryItems: [
			{
				...
				image: ['https://images.unsplash.com/photo-1580481072645-022f9a6d128b'],
				description:
				...
				status: 'Active',
				totalQuantity: 25,
				inventory: [{ locationId: 'shop_cbd_002', locationType: 'Shop', quantity: 6 }],
			...
			},
			{
				...
				status: 'Active',
				totalQuantity: 40,
				inventory: [{ locationId: 'shop_cbd_002', locationType: 'Shop', quantity: 10 }],
			...
			},
			{
				...
				status: 'Active',
				totalQuantity: 32,
				inventory: [{ locationId: 'shop_cbd_002', locationType: 'Shop', quantity: 7 }],
			...
			},
			{
				...
				status: 'Active',
				totalQuantity: 50,
				inventory: [{ locationId: 'shop_cbd_002', locationType: 'Shop', quantity: 12 }],
			...
			},
			{
				...
				status: 'Active',
				totalQuantity: 36,
				inventory: [{ locationId: 'shop_cbd_002', locationType: 'Shop', quantity: 9 }],
				createdAt: '2026-02-05T08:20:00.000Z',
				updatedAt: '2026-02-17T11:10:00.000Z'
			}
		],
		notes: 'Fast-moving urban storefront geared towards lighting, decor, and compact seating.',
		...
		inventoryItems: [
			{
				...
				status: 'Active',
				totalQuantity: 25,
				inventory: [{ locationId: 'shop_nyali_004', locationType: 'Shop', quantity: 4 }],
				createdAt: '2026-01-12T09:14:00.000Z',
				updatedAt: '2026-02-18T16:05:00.000Z'
			},
			{
				...
				status: 'Active',
				totalQuantity: 10,
				inventory: [{ locationId: 'shop_nyali_004', locationType: 'Shop', quantity: 2 }],
				createdAt: '2026-01-22T10:30:00.000Z',
				updatedAt: '2026-02-15T08:50:00.000Z'
			},
			{
				...
				status: 'Active',
				totalQuantity: 45,
				inventory: [{ locationId: 'shop_nyali_004', locationType: 'Shop', quantity: 10 }],
			...
			},
			{
				...
				status: 'Active',
				totalQuantity: 20,
				inventory: [{ locationId: 'shop_nyali_004', locationType: 'Shop', quantity: 6 }],
	...
	},
	{
		...
		address: {
			building: 'Westside Mall, 1st Floor',
			town: 'Nakuru'
		},
		inventorySummary: {
			totalProducts: 3,
			totalItemsInStock: 9,
			totalStockValue: 303700,
		...
		inventoryItems: [
			{
				...
				status: 'Active',
				totalQuantity: 14,
				inventory: [{ locationId: 'shop_nakuru_005', locationType: 'Shop', quantity: 3 }],
			...
			},
			{
				...
				status: 'Active',
				totalQuantity: 36,
				inventory: [{ locationId: 'shop_nakuru_005', locationType: 'Shop', quantity: 4 }],
				createdAt: '2026-02-05T08:20:00.000Z',
				updatedAt: '2026-02-17T11:10:00.000Z'
			},
			{
				...
				status: 'Active',
				totalQuantity: 7,
				inventory: [{ locationId: 'shop_nakuru_005', locationType: 'Shop', quantity: 2 }],
				createdAt: '2026-02-12T09:10:00.000Z',
				updatedAt: '2026-02-24T08:00:00.000Z'
			}
		],
		notes: 'Currently undergoing floor floor renovation; stock levels scaled down temporarily.',
