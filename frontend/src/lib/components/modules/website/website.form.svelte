    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-12">
        ...
        <div class="space-y-6 lg:col-span-7">
                ...
                <CardContent class="grid gap-6 sm:grid-cols-2">
                    ...
                    <div class="space-y-2 sm:col-span-2">
                        ...
                        <Select.Root type="single" name="category" bind:value={category}>
                            <Select.Trigger class="flex h-9 w-full items-center justify-between gap-2 rounded-md border bg-background px-3 py-1 text-xs shadow-sm">
            ...
            <Card>
                ...
                <CardContent class="grid gap-6 sm:grid-cols-2">
                    <div class="space-y-2">
                        <Label for="sellingPrice">Selling Price (KES) <span class="text-destructive">*</span></Label>
                        <Input
                            id="sellingPrice"
                            type="number"
                            min="0"
